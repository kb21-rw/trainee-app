...
router.get("/my-trainees", authenticate_1.verifyJWT, auth_controller_1.get_my_trainees);
router.get("/coaches", authenticate_1.verifyJWT, auth_controller_1.get_coaches);
router.get("/users", authenticate_1.verifyJWT, auth_controller_1.get_users);
...
router.put("/edit-trainee/:id", authenticate_1.verifyJWT, auth_controller_1.editTrainee);
